(function () {
    ...
    async function loadDashboard() {
        ...
        UI.panel("dashboard-live-taxpayer-panel", "Tổng quan Hoạt động Người nộp thuế (Nhóm 3-11)", "dashboard_customize", `
            <div class="grid grid-cols-1 md:grid-cols-4 gap-3">
                ...
                <div class="p-3 rounded-lg bg-slate-50 border border-slate-200">
                    <p class="text-[9px] uppercase font-bold text-slate-400">Doanh thu lũy kế</p>
                    <p class="font-black text-slate-800">${UI.fmtVnd(threshold.cumulative_revenue)}</p>
                </div>
                <div class="p-3 rounded-lg bg-slate-50 border border-slate-200">
                    <p class="text-[9px] uppercase font-bold text-slate-400">Nợ thuế</p>
                    <p class="font-black text-slate-800">${UI.fmtVnd(debt.total_debt)}</p>
                </div>
                <div class="p-3 rounded-lg bg-slate-50 border border-slate-200">
                    <p class="text-[9px] uppercase font-bold text-slate-400">Hóa đơn</p>
