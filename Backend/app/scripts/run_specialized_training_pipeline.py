...
def _print_quality_summary(file_name: str) -> None:
...
def run_pipeline(args: argparse.Namespace) -> int:
    ...
    _print_quality_summary("audit_value_quality_report.json")
    _print_quality_summary("vat_refund_quality_report.json")
    if not args.skip_pilot:
...
def main() -> int:
    ...
    parser.add_argument("--assessment-rows", type=int, default=8000, help="Rows inserted into ai_risk_assessments")
    parser.add_argument("--label-rows", type=int, default=12000, help="Rows inserted into inspector_labels")
